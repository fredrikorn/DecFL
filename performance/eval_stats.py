...
data = {'CPU %': cpu_enh, 'MEM USAGE / LIMIT': mem_enh}
workers_enh = pd.DataFrame(data=data)
...
sum_ori = worker1_ori['CPU %'] + worker2_ori['CPU %'] + worker3_ori['CPU %'] 
workers_ori = sum_ori
...
data = {'CPU %': cpu_ori, 'MEM USAGE / LIMIT': mem_ori}
workers_ori = pd.DataFrame(data=data)
